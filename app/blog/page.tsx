    ...
    <main className="legal-shell text-white">
      <div className="mx-auto max-w-4xl px-5 py-10 lg:px-8 lg:py-14">
        ...
        <section className="legal-card rounded-[2rem] p-7 md:p-10">
          ...
          <h1 className="mt-5 text-4xl font-black tracking-[-0.04em] md:text-5xl">Blog in Vorbereitung</h1>
          <p className="mt-4 max-w-2xl text-lg leading-8 text-white/76">
            Hier werden in Kürze Reviews, Vergleiche und Guides zu AI-Tools, Automatisierung und digitalen Einkommenssystemen erscheinen.
          </p>
        </section>
      </div>
    </main>
